...
- Electron embeds Node 24.18.1, above the hardened runtime's Node 22.12 minimum, and gives the renderer one deterministic Chromium target across desktop platforms.
